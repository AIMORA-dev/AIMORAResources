...
`AIMORAReferenceModels` is the minimal public owner reserved for small analytical and manufactured models used as independent checks. It contains no historical oracle, production solver, or unqualified benchmark claim.
