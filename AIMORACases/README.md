...
`AIMORACases` is the canonical source of public AIMORA examples and benchmark inputs. Documentation, package tests, and qualification systems should consume versioned cases instead of maintaining copies.
