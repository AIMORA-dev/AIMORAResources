...
function main()
    ...
    plot_path = write_waveform_svg(
        ...
        title = "AIMORA Top-Level Study API Status",
        x_label = "catalog row",
    ...
    summary_path = write_key_value_summary(
        ...
        (
            ...
            catalog_scope = "top-level callable study APIs; not overall product or EMT capability completion",
            advertised_studies = length(studies),
            implemented_study_count = length(implemented),
