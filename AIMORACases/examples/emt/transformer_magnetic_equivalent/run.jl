...
result = run_transformer_product(output_dir, :emt_transformer_magnetic_equivalent)
println("Magnetic-equivalent transformer product: steps=", result.result.accepted_step_count,
