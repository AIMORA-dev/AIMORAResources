...
result = run_transformer_product(output_dir, :emt_transformer_wideband_black_box)
println("Wideband transformer product: steps=", result.result.accepted_step_count,
