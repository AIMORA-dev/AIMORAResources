...
result = run_machine_product(output_dir, :emt_machine_permanent_magnet)
println("Permanent-magnet product: steps=", result.trace.result.diagnostics.accepted_step_count,
