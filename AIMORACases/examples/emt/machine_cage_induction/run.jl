...
result = run_machine_product(output_dir, :emt_machine_cage_induction)
println("Cage induction product: steps=", result.trace.result.diagnostics.accepted_step_count,
