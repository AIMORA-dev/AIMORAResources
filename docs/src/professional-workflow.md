...
Use an isolated Julia project and retain exact repository revisions.
...
|---|---|
| Workspace revision | Git commit SHA and branch or tag |
...
- fixed or declared adaptive timestep policy;
