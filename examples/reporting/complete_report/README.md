...
The waveform is manufactured solely to validate reporting behavior. It does not qualify the EMT solver, a physical RLC case, a standard, or a commercial report profile. Numerical qualification remains owned by `AIMORAValidation`.
