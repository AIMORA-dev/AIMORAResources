...
The source-to-example audit indexes 464 discovered records: 9 public package testsets, 79 validation suites, 71 remaining validation fixtures, 55 canonical public case inputs consumed directly by validation, 16 classic public cases plus their shared provenance record, 11 implemented C301–C311 capability packets, 14 claimed but nonexistent C312–C325 packet designations, 93 official ATPDraw web cases, 52 bundled ATPDraw ACP projects/groups, and the claimed but unidentified DC-1–DC-63 collection. Of these records, 197 map to direct examples or explicit gallery variants; every other record has a named oracle, validation, negative-test, external-conversion, nonexistent-designation, or missing-source disposition.
