...
result = run_transformer_product(output_dir, :emt_transformer_low_frequency)
println("Low-frequency transformer product: steps=", result.result.accepted_step_count,
