...
function main()
    ...
    source = line_parameter_example_source("public cable geometry and material")
    segment = example_cable_segment(source, example_soil(source))
    parameters = line_parameter_set(:public_cable_route, [segment])
    ...
    println("Cable line parameter artifacts: ", artifacts)
end
